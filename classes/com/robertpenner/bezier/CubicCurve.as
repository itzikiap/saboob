package com.robertpenner.bezier {
...
public class CubicCurve {	
	...
	public function CubicCurve(mc:Sprite) {
		this.mc = mc;
	}
	...
	private function _cBez(a:Object, b:Object, c:Object, d:Object, k:Number):void {		
		...
		if (dx*dx + dy*dy > k) {
			...
			this.mc.graphics.curveTo (s.x, s.y, d.x, d.y);
			this._xpen = d.x;
			this._ypen = d.y;
		}
	}
	
	private function drawBezierPts(p1:Object, p2:Object, p3:Object, p4:Object, tolerance:Number = -1):void {		
		if (tolerance == -1) {
			tolerance = 5;
		}
	...
	public function drawBezier(x1:Number, y1:Number, x2:Number, y2:Number, x3:Number, y3:Number, 
							x4:Number, y4:Number, tolerance:Number = -1):void {	
	...
	private function curveToCubic(x1:Number, y1:Number, x2:Number, y2:Number, 
								x3:Number, y3:Number, tolerance:Number = -1):void {		
	...
	private function curveToCubicPts(p1:Object, p2:Object, p3:Object, tolerance:Number = -1):void {		
		if (tolerance == -1) {
			tolerance = 5;
		}
		this._cBez (
