...
/**
 *  The Quad class defines three easing functions to implement 
 *  quadratic motion with Flex effect classes. The acceleration of motion 
 *  for a Quad easing equation if slower than for a Cubic or Quart easing equation.
 *
 *  For more information, see http://www.robertpenner.com/profmx.
 */  
public class Quad //AS3 should be named Quadratic
{
	//--------------------------------------------------------------------------
	//
	//  Class methods
